...
class QualificationPlanDetailView(QualificationAccessMixin, DetailView):
    model = QualificationPlan
    template_name = "qualification/plan_detail.html"
...
class QualificationPlanCreateView(QualificationEditMixin, CreateView):
    ...
    def get_initial(self):
        ...
        initial.setdefault("interval_value", settings.default_qualification_interval_value)
        initial.setdefault("interval_unit", settings.default_qualification_interval_unit)
        initial.setdefault("warning_days", settings.default_qualification_warning_days)
        return initial
...
class QualificationEventCreateView(QualificationEditMixin, CreateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        self.plan = QualificationPlan.objects.select_related("asset").get(pk=kwargs["plan_pk"])
